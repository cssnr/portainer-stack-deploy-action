...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------- | :--: | :---: | --------------------------------------------------------- |
| [![GitHub Tag](https://img.shields.io/github/v/tag/cssnr/portainer-stack-deploy-action?filter=!v*.*&style=for-the-badge&label=%20&color=limegreen)](https://github.com/cssnr/portainer-stack-deploy-action/releases/latest)     | `vN`     | `vN.x.x` |  ✅  |  ✅   | Includes new features but is always backwards compatible. |
| [![GitHub Tag](https://img.shields.io/github/v/tag/cssnr/portainer-stack-deploy-action?filter=!v*.*.*&style=for-the-badge&label=%20&color=yellowgreen)](https://github.com/cssnr/portainer-stack-deploy-action/releases/latest) | `vN.N`   | `vN.N.x` |  ✅  |  ❌   | Only receives bug fixes. This is the most stable tag.     |
